...
//  GOALS *** Add colors to change with ternerary operator (check it on docs to see if you can)
...
If you call .changeColor(), shouldn't you then also have to call .render() again? .changeColor() only makes it so that,
the next time that you render, the color will be different. 
